...
public class World
{
	...
	public World(int h, int w)
	{
		...
		BouncingSprite bouncer = new BouncingSprite( 5, 5 ,3, 3, "circle.png", 1.5, 4);
		HeavySprite heavy = new HeavySprite( 5, 5 ,3, 3, "triangle.png", 1.5, 4);
		ControllableSprite control = new ControllableSprite( 5, 5 ,3, 3, "square.png", 1.5, 4);
		add(bouncer);
		add(heavy);
		add( control);
		System.out.println(bouncer.overlaps(heavy));
		run();
	}

	private void addSprites()
	{
		sprites.add(new StationarySprite(5, 5 ,3, 3, "square.png" ) ) ;
	}
